                ...
                <div class="flex flex-wrap ">
                    ...
                    <div class="sm:w-full pr-4 pl-4 md:w-1/3 pr-4 pl-4">
                        <input class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded"
                               type="text" id="product" wire:model="product"
                    ...
                    <div class="sm:w-1/2 pr-4 pl-4 md:w-1/4 pr-4 pl-4">
                        ...
                        @enderror
                        <input class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded"
                               type="text" id="amount" wire:model="amount"
                    ...
                    <div class="sm:w-1/2 pr-4 pl-4 md:w-1/4 pr-4 pl-4">
                        ...
                        @enderror
                        <input class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded"
                               type="text" id="cost" wire:model="cost"
                    ...
                    <div class="flex flex-wrap ">
                        <div class="relative flex-grow max-w-full flex-1 px-4"
                            ...
                            <ul class="list-unstyled">
                                <li style="background: rgba(255,255,255,0.1);border-radius: 11px;padding-right: 3px;padding-left: 15px;border: 1px solid rgba(255,255,255,0.4);">
                                        <span class="float-end" style="margin-right: 10px;">
                                        <button class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline fa fa-remove text-red-600"
                                                wire:click='delete({{$item->id}})'></button>
                                        </span> {{ $item->amount }} - {{ $item->product }} - R$ {{ $item->cost }} (un.)
                                </li>
                            </ul>
                        </div>
                    </div>
