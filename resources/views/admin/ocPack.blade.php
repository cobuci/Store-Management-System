    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 10px;margin-top: 20px;">
            <div class="col-sm-12 col-md-4 offset-md-4" style="border-style: none;">
                ...
                <div
                        class="card bg-light shadow-lg col-md-12 col-sm-12"
                                ...
                                <div class="col-12" style="margin-bottom: 15px;">
                                    ...
                                    <select class="form-select text-light bg-dark"
                                        ...
                                        <optgroup label="selectedPack">
                                            @foreach (Product::listar() as $prod)
                                    ...
                                    <input class="form-control" type="number" id="qtProd"
                                           required="" placeholder="Quantidade (*)" name="qtProd"
                                    ...
                                    <button class="btn btn-outline-light font-monospace shadow-sm"
                                            ...
                                            type="submit" style="border-radius: 10px;margin-top: 10px;width: 100%;"
                                            title="Adicionar">Abrir
                                    </button>
                                </div>
                            </div>
                        </form>
