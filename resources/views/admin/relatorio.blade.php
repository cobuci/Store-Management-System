                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content"
                        ...
                        <div class="modal-header text-light"
                            style="border-top-left-radius: 15px;border-top-right-radius: 15px;background: #262626;">
                            <h4 class="modal-title">#{{ $item->id }}</h4><button type="button"
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 col-md-12 text-nowrap text-light"
                                        ...
                                        <h2 class="text-uppercase text-center" style="margin-bottom: 16px;">Valores
                                        </h2>
                                        <p>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 col-md-12 text-nowrap text-light"
                                        ...
                                        <h2 class="text-uppercase text-center" style="margin-bottom: 16px;">Produtos
                                        </h2>
