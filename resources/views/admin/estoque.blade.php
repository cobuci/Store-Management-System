...
@section('content')
    ...
    <div class="container" style="margin-bottom: 50px">
        <div class="row row-cols-3 font-monospace fs-6 text-center text-light justify-content-center align-items-center"
            ...
            <div class="col"
                style="background: #3d3d3d;border-top-left-radius: 10px;border-bottom-left-radius: 10px;">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="font-monospace text-truncate">
                        ...
                        <div class="collapse col-12" id="{{ 'key' . $cat->id }}">
                            <div class="card">
                                <div class="card-body" style="padding: 0px">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-borderless">
                                                        ...
                                                        <tr style="background: {{ $produto->quantidade <= 0 ? "indianred": null }};" >
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('admin.produto.editar', $produto->id) }}"
                                                                    class="btn btn-outline-primary col-6" type="submit">
                                                                    Editar
                                                                </a>

                                                                <button class="btn btn-outline-danger col-6" type="button"
